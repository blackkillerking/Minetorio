...
public class AnimalHideItem extends Item {
    public AnimalHideItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        if(isSneaking && isMainHand && isStone && isClear){
            pContext.getLevel().setBlock(pContext.getClickedPos().above(), ModBlocks.ANIMAL_HIDE.get().defaultBlockState(), 3);
