...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        //PRIMITIVE OVEN RECIPES
        primitiveOvenRecipeBuilder(1, 1800, "tin", ModItems.HEATED_INGOT.get(), 50, 1200, false, pWriter, "has_raw_tin", ModItems.RAW_TIN.get(), "_from_smelting", Ingredient.of(Items.COAL), Ingredient.of(Items.COAL), Ingredient.of(ModItems.RAW_TIN.get()), Ingredient.EMPTY);
        primitiveOvenRecipeBuilder(1, 1800, "copper", ModItems.HEATED_INGOT.get(), 50, 1200, false, pWriter, "has_raw_copper", Items.RAW_COPPER, "_from_smelting", Ingredient.of(Items.COAL), Ingredient.of(Items.COAL), Ingredient.of(Items.RAW_COPPER), Ingredient.EMPTY);
        primitiveOvenRecipeBuilder(1, 2400, "zinc", ModItems.HEATED_INGOT.get(), 100, 1800, true, pWriter, "has_raw_zinc", ModItems.RAW_ZINC.get(), "_from_smelting", Ingredient.of(Items.COAL), Ingredient.of(Items.COAL), Ingredient.of(Items.COAL), Ingredient.of(ModItems.RAW_ZINC.get()));
        primitiveOvenRecipeBuilder(1, 2400, "silver", ModItems.HEATED_INGOT.get(), 100, 1800,true, pWriter, "has_raw_silver", ModItems.RAW_SILVER.get(), "_from_smelting", Ingredient.of(Items.COAL), Ingredient.of(Items.COAL), Ingredient.of(Items.COAL), Ingredient.of(ModItems.RAW_SILVER.get()));
        primitiveOvenRecipeBuilder(1, 3000, "iron", ModItems.HEATED_INGOT.get(), 200, 2100, true, pWriter, "has_raw_iron", Items.RAW_IRON, "_from_smelting", Ingredient.of(Items.COAL), Ingredient.of(Items.COAL), Ingredient.of(Items.COAL), Ingredient.of(Items.RAW_IRON));
        primitiveOvenRecipeBuilder(1, 2000, "gold", ModItems.HEATED_INGOT.get(), 250, 1800, true, pWriter, "has_raw_gold", Items.RAW_GOLD, "_from_smelting", Ingredient.of(Items.COAL), Ingredient.of(Items.COAL), Ingredient.of(Items.COAL), Ingredient.of(Items.RAW_GOLD));

        for(String metalType : metalTypes){
            primitiveOvenRecipeBuilder(1, 1200, metalType, ModItems.HEATED_SHEET.get(), 0, 200, false, pWriter, "has_" + metalType + "_sheet", ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_sheet")), "_from_reheating", Ingredient.of(Items.COAL), Ingredient.of(ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_sheet"))), Ingredient.EMPTY, Ingredient.EMPTY);
            primitiveOvenRecipeBuilder(1, 800, metalType, ModItems.HEATED_STRIPE.get(), 0, 200, false, pWriter, "has_" + metalType + "_stripe", ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_stripe")), "_from_reheating", Ingredient.of(Items.COAL), Ingredient.of(ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_stripe"))), Ingredient.EMPTY, Ingredient.EMPTY);
            primitiveOvenRecipeBuilder(1, 1200, metalType, ModItems.HEATED_PANEL.get(), 0, 300, false, pWriter, "has_" + metalType + "_panel", ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_panel")), "_from_reheating", Ingredient.of(Items.COAL), Ingredient.of(ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_panel"))), Ingredient.EMPTY, Ingredient.EMPTY);
            primitiveOvenRecipeBuilder(1, 200, metalType, ModItems.HEATED_WIRE.get(), 0, 50, false, pWriter, "has_" + metalType + "_wire", ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_wire")), "_from_reheating", Ingredient.of(Items.COAL), Ingredient.of(ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_wire"))), Ingredient.EMPTY, Ingredient.EMPTY);
            primitiveOvenRecipeBuilder(1, 400, metalType, ModItems.HEATED_ROD.get(), 0, 100,false, pWriter, "has_" + metalType + "_rod", ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_rod")), "_from_reheating", Ingredient.of(Items.COAL), Ingredient.of(ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_rod"))), Ingredient.EMPTY, Ingredient.EMPTY);
            primitiveOvenRecipeBuilder(1, 40, metalType, ModItems.HEATED_SCREWS.get(), 0, 20,false, pWriter, "has_" + metalType + "_screws", ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_screws")), "_from_reheating", Ingredient.of(Items.COAL), Ingredient.of(ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_screws"))), Ingredient.EMPTY, Ingredient.EMPTY);
            primitiveOvenRecipeBuilder(1, 800, metalType, ModItems.HEATED_COLUMN.get(), 0, 200,false, pWriter, "has_" + metalType + "_column", ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_column")), "_from_reheating", Ingredient.of(Items.COAL), Ingredient.of(ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_column"))), Ingredient.EMPTY, Ingredient.EMPTY);
            primitiveOvenRecipeBuilder(1, 40, metalType, ModItems.HEATED_RING.get(), 0, 20,false, pWriter, "has_" + metalType + "_ring", ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_ring")), "_from_reheating", Ingredient.of(Items.COAL), Ingredient.of(ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_ring"))), Ingredient.EMPTY, Ingredient.EMPTY);

            if(!(metalType == "iron" || metalType == "gold" || metalType == "copper")){
                primitiveOvenRecipeBuilder(1, 1800, metalType, ModItems.HEATED_INGOT.get(), 0, 400, false, pWriter, "has_" + metalType + "_ingot", ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_ingot")), "_from_reheating", Ingredient.of(Items.COAL),Ingredient.of(ForgeRegistries.ITEMS.getValue(new ResourceLocation(Minetorio.MOD_ID, metalType + "_ingot"))), Ingredient.EMPTY, Ingredient.EMPTY);
            }
        }

        primitiveOvenRecipeBuilder(1, 1800, "iron", ModItems.HEATED_INGOT.get(), 0, 400, false, pWriter, "has_iron_ingot", Items.IRON_INGOT, "_from_reheating", Ingredient.of(Items.COAL), Ingredient.of(Items.IRON_INGOT), Ingredient.EMPTY, Ingredient.EMPTY);
        primitiveOvenRecipeBuilder(1, 1800, "gold", ModItems.HEATED_INGOT.get(), 0, 400, false, pWriter, "has_gold_ingot", Items.GOLD_INGOT, "_from_reheating", Ingredient.of(Items.COAL), Ingredient.of(Items.GOLD_INGOT), Ingredient.EMPTY, Ingredient.EMPTY);
        primitiveOvenRecipeBuilder(1, 1800, "copper", ModItems.HEATED_INGOT.get(), 0, 400, false, pWriter, "has_copper_ingot", Items.COPPER_INGOT, "_from_reheating", Ingredient.of(Items.COAL), Ingredient.of(Items.COPPER_INGOT), Ingredient.EMPTY, Ingredient.EMPTY);

        //METAL SHAPING RECIPES
        for(String metalType : metalTypes){
    ...
    private void primitiveOvenRecipeBuilder(int pCount, int pCoolingTime, String pMetalType, Item pResult, float pExperience, int pCookingTime, boolean pNeedBellow, Consumer<FinishedRecipe> pWriter, String pUnlockKey, Item pUnlockItem, String pRecipeName, Ingredient... ingredients){
        List<Ingredient> primitiveOvenRecipe = Arrays.stream(ingredients).toList();

        new PrimitiveSmeltingRecipeBuilder(primitiveOvenRecipe, pCount, pCoolingTime, pMetalType, pResult, pExperience, pCookingTime, pNeedBellow)
